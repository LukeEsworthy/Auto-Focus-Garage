...
1. Clone this repo to your machine \*`git clone https://github.com/LukeEsworthy/Auto-Focus-Garage.git`
...
5. Create and export a variable `UnsplashAPIKey` and give it the value of your unique API key from Unsplash.
   _`const UnsplashAPIKey = "YOUR-API-KEY-HERE";`
   _`export default UnsplashAPIKey;`
...
8. In another terminal tab, navigate into the API folder to run the json server.
   _`cd api`
   _`json-server -p 5002 -w database.json`
